<template>
  <div>
    ...
    <base-message
      v-if="showMsg"
      :msgType="'success'"
      :msg="messages.USER_ADDED"
    ></base-message>

    <div class="registration-container">
      <base-header>
        <template #heading> {{headings.Add_USER_HEADING}} </template>
        <template #description> {{headings.ADD_USER_DESC }}</template>
      </base-header>
          ...
          <div class="form-group">
            ...
            <div class="dropdowns">
              ...
              <div
                ...
                class="invalid-feedback"
              >
                {{validations.INVALID_FIELD('Location')}}
              </div>
              <div
...
<script>
import {messages, ddlData, headings, validations, labels}
...
export default {
  ...
  computed: {
    ...
    created(){
     this.userType = this.getLoggedInUser.userType
  },
   validations: {
    user: {
      username: { required },
